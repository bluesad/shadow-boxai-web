...
const Collection = ({ right = false, title, subtitle, image, handleClick }: Props) => (
  <div className={`${right && 'flex-row-reverse self-end'} -mb-8 flex h-96 gap-4 sm:gap-8`}>
    ...
    <div
      className={`mt-10 flex flex-col ${right ? 'items-end text-right' : 'items-start text-left'}`}
    >
