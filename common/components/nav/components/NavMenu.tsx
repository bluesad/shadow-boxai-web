...
import { maskAnimation, menuAnimation, menuItemAnimation } from '../animations/NavMenu.animations';
...
const Anchor = ({
  ...
  <Link href="shoes" passHref legacyBehavior>
    <motion.a
      ...
      {opened && (
        <>
          ...
          <motion.div
            ...
            exit="from"
          >
            <button className="btn-icon absolute right-10 top-5" onClick={() => setOpened(false)}>
              <AiOutlineClose />
            </button>
